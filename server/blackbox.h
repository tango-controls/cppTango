...
public:
	...
	void insert_attr(const Tango::DevVarStringArray &, long vers=1);
	void insert_attr(const Tango::AttributeValueList &);
...
private:
	...
	static bool		sync_model_read;
	static bool		need_thread_sync;
	omni_mutex		sync;
