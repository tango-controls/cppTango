...
//						 
					...
					//cout << "Old host = " << ipos->second.notifyd_host << endl;
					//cout << "New host = " << info.server_host << endl;
...
//
				...
				//cout << "Notify daemon failed : " << ipos->second.notifd_failed << endl;
				if ( ipos->second.notifd_failed == true )
				{
					bool notifd_reco = reconnect_to_channel(ipos,event_consumer);
					//cout << "Notify daemon reconnect : " << notifd_reco << endl;
					if ( notifd_reco )
