...
_CORBA_MODULE_BEG
  ...
  _CORBA_MODULE_VAR _dyn_attr const CORBA::TypeCode_ptr _tc_DevVarLongLongArray;

  class DevVarLongLongArray_var;

  class DevVarLongLongArray : public _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 >  {
  public:
    typedef DevVarLongLongArray_var _var_type;
    inline DevVarLongLongArray() {}
    inline DevVarLongLongArray(const DevVarLongLongArray& _s)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > (_s) {}

    inline DevVarLongLongArray(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > (_max) {}
    inline DevVarLongLongArray(_CORBA_ULong _max, _CORBA_ULong _len, CORBA::LongLong* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > (_max, _len, _val, _rel) {}

  

    inline DevVarLongLongArray& operator = (const DevVarLongLongArray& _s) {
      _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > ::operator=(_s);
      return *this;
    }
  };

  class DevVarLongLongArray_out;

  class DevVarLongLongArray_var {
  public:
    inline DevVarLongLongArray_var() : _pd_seq(0) {}
    inline DevVarLongLongArray_var(DevVarLongLongArray* _s) : _pd_seq(_s) {}
    inline DevVarLongLongArray_var(const DevVarLongLongArray_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DevVarLongLongArray(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DevVarLongLongArray_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DevVarLongLongArray_var& operator = (DevVarLongLongArray* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DevVarLongLongArray_var& operator = (const DevVarLongLongArray_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DevVarLongLongArray;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DevVarLongLongArray* operator -> () { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DevVarLongLongArray& () const { return *_pd_seq; }
#else
    inline operator const DevVarLongLongArray& () const { return *_pd_seq; }
    inline operator DevVarLongLongArray& () { return *_pd_seq; }
#endif
      
    inline const DevVarLongLongArray& in() const { return *_pd_seq; }
    inline DevVarLongLongArray&       inout()    { return *_pd_seq; }
    inline DevVarLongLongArray*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DevVarLongLongArray* _retn() { DevVarLongLongArray* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DevVarLongLongArray_out;
    
  private:
    DevVarLongLongArray* _pd_seq;
  };

  class DevVarLongLongArray_out {
  public:
    inline DevVarLongLongArray_out(DevVarLongLongArray*& _s) : _data(_s) { _data = 0; }
    inline DevVarLongLongArray_out(DevVarLongLongArray_var& _s)
      : _data(_s._pd_seq) { _s = (DevVarLongLongArray*) 0; }
    inline DevVarLongLongArray_out(const DevVarLongLongArray_out& _s) : _data(_s._data) {}
    inline DevVarLongLongArray_out& operator = (const DevVarLongLongArray_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DevVarLongLongArray_out& operator = (DevVarLongLongArray* _s) {
      _data = _s;
      return *this;
    }
    inline operator DevVarLongLongArray*&()  { return _data; }
    inline DevVarLongLongArray*& ptr()       { return _data; }
    inline DevVarLongLongArray* operator->() { return _data; }
    ...
    DevVarLongLongArray*& _data;

  private:
    DevVarLongLongArray_out();
    DevVarLongLongArray_out& operator=(const DevVarLongLongArray_var&);
  };

  _CORBA_MODULE_VAR _dyn_attr const CORBA::TypeCode_ptr _tc_DevVarULongLongArray;

  class DevVarULongLongArray_var;

  class DevVarULongLongArray : public _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 >  {
  public:
    typedef DevVarULongLongArray_var _var_type;
    inline DevVarULongLongArray() {}
    inline DevVarULongLongArray(const DevVarULongLongArray& _s)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > (_s) {}

    inline DevVarULongLongArray(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > (_max) {}
    inline DevVarULongLongArray(_CORBA_ULong _max, _CORBA_ULong _len, CORBA::ULongLong* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > (_max, _len, _val, _rel) {}

  

    inline DevVarULongLongArray& operator = (const DevVarULongLongArray& _s) {
      _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > ::operator=(_s);
      return *this;
    }
  };

  class DevVarULongLongArray_out;

  class DevVarULongLongArray_var {
  public:
    inline DevVarULongLongArray_var() : _pd_seq(0) {}
    inline DevVarULongLongArray_var(DevVarULongLongArray* _s) : _pd_seq(_s) {}
    inline DevVarULongLongArray_var(const DevVarULongLongArray_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DevVarULongLongArray(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DevVarULongLongArray_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DevVarULongLongArray_var& operator = (DevVarULongLongArray* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DevVarULongLongArray_var& operator = (const DevVarULongLongArray_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DevVarULongLongArray;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DevVarULongLongArray* operator -> () { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DevVarULongLongArray& () const { return *_pd_seq; }
#else
    inline operator const DevVarULongLongArray& () const { return *_pd_seq; }
    inline operator DevVarULongLongArray& () { return *_pd_seq; }
#endif
      
    inline const DevVarULongLongArray& in() const { return *_pd_seq; }
    inline DevVarULongLongArray&       inout()    { return *_pd_seq; }
    inline DevVarULongLongArray*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DevVarULongLongArray* _retn() { DevVarULongLongArray* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DevVarULongLongArray_out;
    
  private:
    DevVarULongLongArray* _pd_seq;
  };

  class DevVarULongLongArray_out {
  public:
    inline DevVarULongLongArray_out(DevVarULongLongArray*& _s) : _data(_s) { _data = 0; }
    inline DevVarULongLongArray_out(DevVarULongLongArray_var& _s)
      : _data(_s._pd_seq) { _s = (DevVarULongLongArray*) 0; }
    inline DevVarULongLongArray_out(const DevVarULongLongArray_out& _s) : _data(_s._data) {}
    inline DevVarULongLongArray_out& operator = (const DevVarULongLongArray_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DevVarULongLongArray_out& operator = (DevVarULongLongArray* _s) {
      _data = _s;
      return *this;
    }
    inline operator DevVarULongLongArray*&()  { return _data; }
    inline DevVarULongLongArray*& ptr()       { return _data; }
    inline DevVarULongLongArray* operator->() { return _data; }
    ...
    DevVarULongLongArray*& _data;

  private:
    DevVarULongLongArray_out();
    DevVarULongLongArray_out& operator=(const DevVarULongLongArray_var&);
  };

  _CORBA_MODULE_VAR _dyn_attr const CORBA::TypeCode_ptr _tc_DevVarLong32Array;

  class DevVarLong32Array_var;

  class DevVarLong32Array : public _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 >  {
  public:
    typedef DevVarLong32Array_var _var_type;
    inline DevVarLong32Array() {}
    inline DevVarLong32Array(const DevVarLong32Array& _s)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 > (_s) {}

    inline DevVarLong32Array(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 > (_max) {}
    inline DevVarLong32Array(_CORBA_ULong _max, _CORBA_ULong _len, CORBA::Long* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 > (_max, _len, _val, _rel) {}

  

    inline DevVarLong32Array& operator = (const DevVarLong32Array& _s) {
      _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 > ::operator=(_s);
      return *this;
    }
  };

  class DevVarLong32Array_out;

  class DevVarLong32Array_var {
  public:
    inline DevVarLong32Array_var() : _pd_seq(0) {}
    inline DevVarLong32Array_var(DevVarLong32Array* _s) : _pd_seq(_s) {}
    inline DevVarLong32Array_var(const DevVarLong32Array_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DevVarLong32Array(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DevVarLong32Array_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DevVarLong32Array_var& operator = (DevVarLong32Array* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DevVarLong32Array_var& operator = (const DevVarLong32Array_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DevVarLong32Array;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DevVarLong32Array* operator -> () { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DevVarLong32Array& () const { return *_pd_seq; }
#else
    inline operator const DevVarLong32Array& () const { return *_pd_seq; }
    inline operator DevVarLong32Array& () { return *_pd_seq; }
#endif
      
    inline const DevVarLong32Array& in() const { return *_pd_seq; }
    inline DevVarLong32Array&       inout()    { return *_pd_seq; }
    inline DevVarLong32Array*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DevVarLong32Array* _retn() { DevVarLong32Array* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DevVarLong32Array_out;
    
  private:
    DevVarLong32Array* _pd_seq;
  };

  class DevVarLong32Array_out {
  public:
    inline DevVarLong32Array_out(DevVarLong32Array*& _s) : _data(_s) { _data = 0; }
    inline DevVarLong32Array_out(DevVarLong32Array_var& _s)
      : _data(_s._pd_seq) { _s = (DevVarLong32Array*) 0; }
    inline DevVarLong32Array_out(const DevVarLong32Array_out& _s) : _data(_s._data) {}
    inline DevVarLong32Array_out& operator = (const DevVarLong32Array_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DevVarLong32Array_out& operator = (DevVarLong32Array* _s) {
      _data = _s;
      return *this;
    }
    inline operator DevVarLong32Array*&()  { return _data; }
    inline DevVarLong32Array*& ptr()       { return _data; }
    inline DevVarLong32Array* operator->() { return _data; }
    ...
    DevVarLong32Array*& _data;

  private:
    DevVarLong32Array_out();
    DevVarLong32Array_out& operator=(const DevVarLong32Array_var&);
  };

  _CORBA_MODULE_VAR _dyn_attr const CORBA::TypeCode_ptr _tc_DevVarULong32Array;

  class DevVarULong32Array_var;

  class DevVarULong32Array : public _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULong, 4, 4 >  {
  public:
    typedef DevVarULong32Array_var _var_type;
    inline DevVarULong32Array() {}
    inline DevVarULong32Array(const DevVarULong32Array& _s)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULong, 4, 4 > (_s) {}

    inline DevVarULong32Array(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULong, 4, 4 > (_max) {}
    inline DevVarULong32Array(_CORBA_ULong _max, _CORBA_ULong _len, CORBA::ULong* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULong, 4, 4 > (_max, _len, _val, _rel) {}

  

    inline DevVarULong32Array& operator = (const DevVarULong32Array& _s) {
      _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULong, 4, 4 > ::operator=(_s);
      return *this;
    }
  };

  class DevVarULong32Array_out;

  class DevVarULong32Array_var {
  public:
    inline DevVarULong32Array_var() : _pd_seq(0) {}
    inline DevVarULong32Array_var(DevVarULong32Array* _s) : _pd_seq(_s) {}
    inline DevVarULong32Array_var(const DevVarULong32Array_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DevVarULong32Array(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DevVarULong32Array_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DevVarULong32Array_var& operator = (DevVarULong32Array* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DevVarULong32Array_var& operator = (const DevVarULong32Array_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DevVarULong32Array;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DevVarULong32Array* operator -> () { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DevVarULong32Array& () const { return *_pd_seq; }
#else
    inline operator const DevVarULong32Array& () const { return *_pd_seq; }
    inline operator DevVarULong32Array& () { return *_pd_seq; }
#endif
      
    inline const DevVarULong32Array& in() const { return *_pd_seq; }
    inline DevVarULong32Array&       inout()    { return *_pd_seq; }
    inline DevVarULong32Array*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DevVarULong32Array* _retn() { DevVarULong32Array* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DevVarULong32Array_out;
    
  private:
    DevVarULong32Array* _pd_seq;
  };

  class DevVarULong32Array_out {
  public:
    inline DevVarULong32Array_out(DevVarULong32Array*& _s) : _data(_s) { _data = 0; }
    inline DevVarULong32Array_out(DevVarULong32Array_var& _s)
      : _data(_s._pd_seq) { _s = (DevVarULong32Array*) 0; }
    inline DevVarULong32Array_out(const DevVarULong32Array_out& _s) : _data(_s._data) {}
    inline DevVarULong32Array_out& operator = (const DevVarULong32Array_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DevVarULong32Array_out& operator = (DevVarULong32Array* _s) {
      _data = _s;
      return *this;
    }
    inline operator DevVarULong32Array*&()  { return _data; }
    inline DevVarULong32Array*& ptr()       { return _data; }
    inline DevVarULong32Array* operator->() { return _data; }
    ...
    DevVarULong32Array*& _data;

  private:
    DevVarULong32Array_out();
    DevVarULong32Array_out& operator=(const DevVarULong32Array_var&);
  };
  ...
  struct DevVarLong32StringArray {
    typedef _CORBA_ConstrType_Variable_Var<DevVarLong32StringArray> _var_type;

    
    typedef _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::Long, 4, 4 >  _lvalue_seq;
    _lvalue_seq lvalue;
  ...
  typedef DevVarLong32StringArray::_var_type DevVarLong32StringArray_var;

  typedef _CORBA_ConstrType_Variable_OUT_arg< DevVarLong32StringArray,DevVarLong32StringArray_var > DevVarLong32StringArray_out;

  _CORBA_MODULE_VAR _dyn_attr const CORBA::TypeCode_ptr _tc_DevVarLong32StringArray;
...
extern void operator <<= (CORBA::Any& _a, const Tango::DevVarBooleanArray& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevVarBooleanArray* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarBooleanArray*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarBooleanArray*& _sp);

extern void operator <<= (CORBA::Any& _a, const Tango::DevVarLongLongArray& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevVarLongLongArray* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarLongLongArray*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarLongLongArray*& _sp);

extern void operator <<= (CORBA::Any& _a, const Tango::DevVarULongLongArray& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevVarULongLongArray* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarULongLongArray*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarULongLongArray*& _sp);

extern void operator <<= (CORBA::Any& _a, const Tango::DevVarLong32Array& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevVarLong32Array* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarLong32Array*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarLong32Array*& _sp);

extern void operator <<= (CORBA::Any& _a, const Tango::DevVarULong32Array& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevVarULong32Array* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarULong32Array*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarULong32Array*& _sp);
...
extern void operator<<=(CORBA::Any& _a, const Tango::DevVarLong32StringArray& _s);
extern void operator<<=(CORBA::Any& _a, Tango::DevVarLong32StringArray* _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::DevVarLong32StringArray*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::DevVarLong32StringArray*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::NamedDevError*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::NamedDevError*& _sp);

extern void operator <<= (CORBA::Any& _a, const Tango::NamedDevErrorList& _s);
inline void operator <<= (CORBA::Any& _a, Tango::NamedDevErrorList* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::NamedDevErrorList*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::NamedDevErrorList*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::AttributeDim*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::AttributeDim*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::AttributeValue_3*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::AttributeValue_3*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::ChangeEventProp*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::ChangeEventProp*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::PeriodicEventProp*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::PeriodicEventProp*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::ArchiveEventProp*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::ArchiveEventProp*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::EventProperties*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::EventProperties*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::AttributeAlarm*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::AttributeAlarm*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::AttributeConfig_3*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::AttributeConfig_3*& _sp);
...
extern void operator <<= (CORBA::Any& _a, const Tango::AttributeConfigList_3& _s);
inline void operator <<= (CORBA::Any& _a, Tango::AttributeConfigList_3* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::AttributeConfigList_3*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::AttributeConfigList_3*& _sp);
...
extern void operator <<= (CORBA::Any& _a, const Tango::AttributeValueList_3& _s);
inline void operator <<= (CORBA::Any& _a, Tango::AttributeValueList_3* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::AttributeValueList_3*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::AttributeValueList_3*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::DevInfo_3*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::DevInfo_3*& _sp);
...
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::DevAttrHistory_3*& _sp);
extern CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::DevAttrHistory_3*& _sp);
...
extern void operator <<= (CORBA::Any& _a, const Tango::DevAttrHistoryList_3& _s);
inline void operator <<= (CORBA::Any& _a, Tango::DevAttrHistoryList_3* _sp) {
  _a <<= *_sp;
  delete _sp;
}
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, Tango::DevAttrHistoryList_3*& _sp);
extern _CORBA_Boolean operator >>= (const CORBA::Any& _a, const Tango::DevAttrHistoryList_3*& _sp);
