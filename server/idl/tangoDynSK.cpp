...
static CORBA::TypeCode_ptr _0RL_tc_Tango_mDevVarLongLongArray = CORBA::TypeCode::PR_alias_tc("IDL:Tango/DevVarLongLongArray:1.0", "DevVarLongLongArray", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_longlong_tc()));


#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
  const CORBA::TypeCode_ptr _tc_DevVarLongLongArray = _0RL_tc_Tango_mDevVarLongLongArray;
} 
#else
const CORBA::TypeCode_ptr Tango::_tc_DevVarLongLongArray = _0RL_tc_Tango_mDevVarLongLongArray;
#endif

static CORBA::TypeCode_ptr _0RL_tc_Tango_mDevVarULongLongArray = CORBA::TypeCode::PR_alias_tc("IDL:Tango/DevVarULongLongArray:1.0", "DevVarULongLongArray", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_ulonglong_tc()));


#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
  const CORBA::TypeCode_ptr _tc_DevVarULongLongArray = _0RL_tc_Tango_mDevVarULongLongArray;
} 
#else
const CORBA::TypeCode_ptr Tango::_tc_DevVarULongLongArray = _0RL_tc_Tango_mDevVarULongLongArray;
#endif

static CORBA::TypeCode_ptr _0RL_tc_Tango_mDevVarLong32Array = CORBA::TypeCode::PR_alias_tc("IDL:Tango/DevVarLong32Array:1.0", "DevVarLong32Array", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_long_tc()));


#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
  const CORBA::TypeCode_ptr _tc_DevVarLong32Array = _0RL_tc_Tango_mDevVarLong32Array;
} 
#else
const CORBA::TypeCode_ptr Tango::_tc_DevVarLong32Array = _0RL_tc_Tango_mDevVarLong32Array;
#endif

static CORBA::TypeCode_ptr _0RL_tc_Tango_mDevVarULong32Array = CORBA::TypeCode::PR_alias_tc("IDL:Tango/DevVarULong32Array:1.0", "DevVarULong32Array", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_ulong_tc()));


#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
  const CORBA::TypeCode_ptr _tc_DevVarULong32Array = _0RL_tc_Tango_mDevVarULong32Array;
} 
#else
const CORBA::TypeCode_ptr Tango::_tc_DevVarULong32Array = _0RL_tc_Tango_mDevVarULong32Array;
#endif
...
static CORBA::PR_structMember _0RL_structmember_Tango_mDevVarLong32StringArray[] = {
  {"lvalue", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_long_tc())},
  {"svalue", _0RL_tc_Tango_mDevVarStringArray}
};

static CORBA::TypeCode_ptr _0RL_tc_Tango_mDevVarLong32StringArray = CORBA::TypeCode::PR_struct_tc("IDL:Tango/DevVarLong32StringArray:1.0", "DevVarLong32StringArray", _0RL_structmember_Tango_mDevVarLong32StringArray, 2);
#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
  const CORBA::TypeCode_ptr _tc_DevVarLong32StringArray = _0RL_tc_Tango_mDevVarLong32StringArray;
} 
#else
const CORBA::TypeCode_ptr Tango::_tc_DevVarLong32StringArray = _0RL_tc_Tango_mDevVarLong32StringArray;
#endif
...
#ifndef __0RL_tcParser_buildDesc_s0_clonglong__
#define __0RL_tcParser_buildDesc_s0_clonglong__
static void
_0RL_tcParser_setElementCount_s0_clonglong(const tcSequenceDesc* _desc, CORBA::ULong _len)
{
  ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > *)_desc->opq_seq)->length(_len);
}

static CORBA::ULong
_0RL_tcParser_getElementCount_s0_clonglong(const tcSequenceDesc* _desc)
{
  return ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > *)_desc->opq_seq)->length();
}

static CORBA::Boolean
_0RL_tcParser_getElementDesc_s0_clonglong(const tcSequenceDesc* _desc, CORBA::ULong _index, tcDescriptor& _newdesc, _CORBA_ULong& _contiguous)
{
  _newdesc.p_streamdata = ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > *)_desc->opq_seq)->NP_data();
  _contiguous = ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > *)_desc->opq_seq)->length() - _index;
...
static void
_0RL_buildDesc_s0_clonglong(tcDescriptor &_desc, const _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::LongLong, 8, 8 > & _data)
{
  _desc.p_sequence.opq_seq = (void*) &_data;
  _desc.p_sequence.setElementCount =
    _0RL_tcParser_setElementCount_s0_clonglong;
  _desc.p_sequence.getElementCount =
    _0RL_tcParser_getElementCount_s0_clonglong;
  _desc.p_sequence.getElementDesc =
    _0RL_tcParser_getElementDesc_s0_clonglong;
  }
#endif

void operator <<= (CORBA::Any& _a, const Tango::DevVarLongLongArray& _s)
{
  tcDescriptor tcdesc;
  _0RL_buildDesc_s0_clonglong(tcdesc, _s);
  _a.PR_packFrom(Tango::_tc_DevVarLongLongArray, &tcdesc);
}

void _0RL_seq_delete_Tango_mDevVarLongLongArray(void* _data)
{
  delete (Tango::DevVarLongLongArray*)_data;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarLongLongArray*& _s_out)
{
  return _a >>= (const Tango::DevVarLongLongArray*&) _s_out;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarLongLongArray*& _s_out)
{
  _s_out = 0;
  Tango::DevVarLongLongArray* stmp = (Tango::DevVarLongLongArray*) _a.PR_getCachedData();
  if( stmp == 0 ) {
    tcDescriptor tcdesc;
    stmp = new Tango::DevVarLongLongArray;
    _0RL_buildDesc_s0_clonglong(tcdesc, *stmp);
    if( _a.PR_unpackTo(Tango::_tc_DevVarLongLongArray, &tcdesc)) {
      ((CORBA::Any*)&_a)->PR_setCachedData((void*)stmp, _0RL_seq_delete_Tango_mDevVarLongLongArray);
      _s_out = stmp;
      return 1;
    } else {
      delete (Tango::DevVarLongLongArray *)stmp;
      return 0;
    }
  } else {
    CORBA::TypeCode_var tctmp = _a.type();
    if( tctmp->equivalent(Tango::_tc_DevVarLongLongArray) ) {
      _s_out = stmp;
      return 1;
    } else {
      return 0;
...
#ifndef __0RL_tcParser_buildDesc_s0_cunsigned_plonglong__
#define __0RL_tcParser_buildDesc_s0_cunsigned_plonglong__
static void
_0RL_tcParser_setElementCount_s0_cunsigned_plonglong(const tcSequenceDesc* _desc, CORBA::ULong _len)
{
  ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > *)_desc->opq_seq)->length(_len);
}

static CORBA::ULong
_0RL_tcParser_getElementCount_s0_cunsigned_plonglong(const tcSequenceDesc* _desc)
{
  return ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > *)_desc->opq_seq)->length();
}

static CORBA::Boolean
_0RL_tcParser_getElementDesc_s0_cunsigned_plonglong(const tcSequenceDesc* _desc, CORBA::ULong _index, tcDescriptor& _newdesc, _CORBA_ULong& _contiguous)
{
  _newdesc.p_streamdata = ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > *)_desc->opq_seq)->NP_data();
  _contiguous = ((_CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > *)_desc->opq_seq)->length() - _index;
...
static void
_0RL_buildDesc_s0_cunsigned_plonglong(tcDescriptor &_desc, const _CORBA_Unbounded_Sequence_w_FixSizeElement< CORBA::ULongLong, 8, 8 > & _data)
{
  _desc.p_sequence.opq_seq = (void*) &_data;
  _desc.p_sequence.setElementCount =
    _0RL_tcParser_setElementCount_s0_cunsigned_plonglong;
  _desc.p_sequence.getElementCount =
    _0RL_tcParser_getElementCount_s0_cunsigned_plonglong;
  _desc.p_sequence.getElementDesc =
    _0RL_tcParser_getElementDesc_s0_cunsigned_plonglong;
  }
#endif

void operator <<= (CORBA::Any& _a, const Tango::DevVarULongLongArray& _s)
{
  tcDescriptor tcdesc;
  _0RL_buildDesc_s0_cunsigned_plonglong(tcdesc, _s);
  _a.PR_packFrom(Tango::_tc_DevVarULongLongArray, &tcdesc);
}

void _0RL_seq_delete_Tango_mDevVarULongLongArray(void* _data)
{
  delete (Tango::DevVarULongLongArray*)_data;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarULongLongArray*& _s_out)
{
  return _a >>= (const Tango::DevVarULongLongArray*&) _s_out;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarULongLongArray*& _s_out)
{
  _s_out = 0;
  Tango::DevVarULongLongArray* stmp = (Tango::DevVarULongLongArray*) _a.PR_getCachedData();
  if( stmp == 0 ) {
    tcDescriptor tcdesc;
    stmp = new Tango::DevVarULongLongArray;
    _0RL_buildDesc_s0_cunsigned_plonglong(tcdesc, *stmp);
    if( _a.PR_unpackTo(Tango::_tc_DevVarULongLongArray, &tcdesc)) {
      ((CORBA::Any*)&_a)->PR_setCachedData((void*)stmp, _0RL_seq_delete_Tango_mDevVarULongLongArray);
      _s_out = stmp;
      return 1;
    } else {
      delete (Tango::DevVarULongLongArray *)stmp;
      return 0;
    }
  } else {
    CORBA::TypeCode_var tctmp = _a.type();
    if( tctmp->equivalent(Tango::_tc_DevVarULongLongArray) ) {
      _s_out = stmp;
      return 1;
    } else {
      return 0;
...
void operator <<= (CORBA::Any& _a, const Tango::DevVarLong32Array& _s)
{
  tcDescriptor tcdesc;
  _0RL_buildDesc_s0_clong(tcdesc, _s);
  _a.PR_packFrom(Tango::_tc_DevVarLong32Array, &tcdesc);
}

void _0RL_seq_delete_Tango_mDevVarLong32Array(void* _data)
{
  delete (Tango::DevVarLong32Array*)_data;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarLong32Array*& _s_out)
{
  return _a >>= (const Tango::DevVarLong32Array*&) _s_out;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarLong32Array*& _s_out)
{
  _s_out = 0;
  Tango::DevVarLong32Array* stmp = (Tango::DevVarLong32Array*) _a.PR_getCachedData();
  if( stmp == 0 ) {
    tcDescriptor tcdesc;
    stmp = new Tango::DevVarLong32Array;
    _0RL_buildDesc_s0_clong(tcdesc, *stmp);
    if( _a.PR_unpackTo(Tango::_tc_DevVarLong32Array, &tcdesc)) {
      ((CORBA::Any*)&_a)->PR_setCachedData((void*)stmp, _0RL_seq_delete_Tango_mDevVarLong32Array);
      _s_out = stmp;
      return 1;
    } else {
      delete (Tango::DevVarLong32Array *)stmp;
      return 0;
    }
  } else {
    CORBA::TypeCode_var tctmp = _a.type();
    if( tctmp->equivalent(Tango::_tc_DevVarLong32Array) ) {
      _s_out = stmp;
      return 1;
    } else {
      return 0;
...
void operator <<= (CORBA::Any& _a, const Tango::DevVarULong32Array& _s)
{
  tcDescriptor tcdesc;
  _0RL_buildDesc_s0_cunsigned_plong(tcdesc, _s);
  _a.PR_packFrom(Tango::_tc_DevVarULong32Array, &tcdesc);
}

void _0RL_seq_delete_Tango_mDevVarULong32Array(void* _data)
{
  delete (Tango::DevVarULong32Array*)_data;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, Tango::DevVarULong32Array*& _s_out)
{
  return _a >>= (const Tango::DevVarULong32Array*&) _s_out;
}

CORBA::Boolean operator >>= (const CORBA::Any& _a, const Tango::DevVarULong32Array*& _s_out)
{
  _s_out = 0;
  Tango::DevVarULong32Array* stmp = (Tango::DevVarULong32Array*) _a.PR_getCachedData();
  if( stmp == 0 ) {
    tcDescriptor tcdesc;
    stmp = new Tango::DevVarULong32Array;
    _0RL_buildDesc_s0_cunsigned_plong(tcdesc, *stmp);
    if( _a.PR_unpackTo(Tango::_tc_DevVarULong32Array, &tcdesc)) {
      ((CORBA::Any*)&_a)->PR_setCachedData((void*)stmp, _0RL_seq_delete_Tango_mDevVarULong32Array);
      _s_out = stmp;
      return 1;
    } else {
      delete (Tango::DevVarULong32Array *)stmp;
      return 0;
    }
  } else {
    CORBA::TypeCode_var tctmp = _a.type();
    if( tctmp->equivalent(Tango::_tc_DevVarULong32Array) ) {
      _s_out = stmp;
      return 1;
    } else {
      return 0;
...
void _0RL_delete_Tango_mDevVarLong32StringArray(void* _data) {
  Tango::DevVarLong32StringArray* _0RL_t = (Tango::DevVarLong32StringArray*) _data;
  delete _0RL_t;
}

static CORBA::Boolean
_0RL_tcParser_getMemberDesc_Tango_mDevVarLong32StringArray(const tcStructDesc *_desc, CORBA::ULong _index, tcDescriptor &_newdesc){
  switch (_index) {
  case 0:
    _0RL_buildDesc_s0_clong(_newdesc, ((Tango::DevVarLong32StringArray*)_desc->opq_struct)->lvalue);
    return 1;
  case 1:
    _0RL_buildDesc_s0_cstring(_newdesc, ((Tango::DevVarLong32StringArray*)_desc->opq_struct)->svalue);
    return 1;
...
_0RL_tcParser_getMemberCount_Tango_mDevVarLong32StringArray(const tcStructDesc *_desc)
{
  return 2;
}

void _0RL_buildDesc_cTango_mDevVarLong32StringArray(tcDescriptor &_desc, const Tango::DevVarLong32StringArray& _data)
{
  _desc.p_struct.getMemberDesc = _0RL_tcParser_getMemberDesc_Tango_mDevVarLong32StringArray;
  _desc.p_struct.getMemberCount = _0RL_tcParser_getMemberCount_Tango_mDevVarLong32StringArray;
  _desc.p_struct.opq_struct = (void *)&_data;
}



void operator<<=(CORBA::Any& _a, const Tango::DevVarLong32StringArray& _s) {
  tcDescriptor _0RL_tcdesc;
  _0RL_buildDesc_cTango_mDevVarLong32StringArray(_0RL_tcdesc, _s);
  _a.PR_packFrom(_0RL_tc_Tango_mDevVarLong32StringArray, &_0RL_tcdesc);
}
 
void operator<<=(CORBA::Any& _a, Tango::DevVarLong32StringArray* _sp) {
  tcDescriptor _0RL_tcdesc;
  _0RL_buildDesc_cTango_mDevVarLong32StringArray(_0RL_tcdesc, *_sp);
  _a.PR_packFrom(_0RL_tc_Tango_mDevVarLong32StringArray, &_0RL_tcdesc);
  delete _sp;
}

CORBA::Boolean operator>>=(const CORBA::Any& _a, Tango::DevVarLong32StringArray*& _sp) {
  return _a >>= (const Tango::DevVarLong32StringArray*&) _sp;
}

CORBA::Boolean operator>>=(const CORBA::Any& _a, const Tango::DevVarLong32StringArray*& _sp) {
  _sp = (Tango::DevVarLong32StringArray *) _a.PR_getCachedData();
  if (_sp == 0) {
    tcDescriptor _0RL_tcdesc;
    _sp = new Tango::DevVarLong32StringArray;
    _0RL_buildDesc_cTango_mDevVarLong32StringArray(_0RL_tcdesc, *_sp);
    if (_a.PR_unpackTo(_0RL_tc_Tango_mDevVarLong32StringArray, &_0RL_tcdesc)) {
      ((CORBA::Any *)&_a)->PR_setCachedData((void*)_sp, _0RL_delete_Tango_mDevVarLong32StringArray);
      return 1;
    } else {
      delete (Tango::DevVarLong32StringArray *)_sp; _sp = 0;
      return 0;
    }
  } else {
    CORBA::TypeCode_var _0RL_tctmp = _a.type();
    if (_0RL_tctmp->equivalent(_0RL_tc_Tango_mDevVarLong32StringArray)) return 1;
    _sp = 0;
    return 0;
  }
}
