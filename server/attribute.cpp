...
:date(true),check_min_alarm(false),check_max_alarm(false),
 ...
 min_alarm_on(false),max_alarm_on(false),quality(Tango::ATTR_VALID)
{
...
//
	...
	ext->event_period = (int)(1000.0 * DELTA_PERIODIC);  	// default for event period is 1 second
	...
	try
	{
			...
			long event_period=0;
                	...
                	str >> event_period;
			if (event_period > 0)
				ext->event_period = (int)((double)event_period * DELTA_PERIODIC);
...
//
	...
	ext->archive_period = 10 * (int)(1000.0 * DELTA_PERIODIC);  
