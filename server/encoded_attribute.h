...
/**
 * Encode a 8bit grayscale image as JPEG format
 *
...
/**
 * Encode a 32bit rgb color image as JPEG format
 *
...
/**
 * Encode a 24bit rgb color image as JPEG format
 *
...
/**
 * Encode a 8bit grayscale image (no compression)
 *
 * @param gray8    Array of 8bit gray sample
 * @param width    The image width
 * @param height   The image height
 ...
 */
 ...
 /**
 * Encode a 16bit grayscale image (no compression)
 *
 ...
 */
 ...
 /**
 * Encode a 24bit color image (no compression)
 *
 ...
 */
 ...
 /**
 * Decode a color image (JPEG_RGB or RGB24) and returns a 32bit RGB image.
 * Throws DevFailed in case of failure.
 *
 * @param attr     DeviceAttirbute that contains the image
 ...
 */
 ...
 /**
 * Decode a 8bits grayscale image (JPEG_GRAY8 or GRAY8) and returns a 8bit gray scale image.
 * Throws DevFailed in case of failure.
 *
 * @param attr     DeviceAttirbute that contains the image
 * @param width    Width of the image
 ...
 */
 ...
 /**
 * Decode a 16bits grayscale image (GRAY16) and returns a 8bit gray scale image.
 * Throws DevFailed in case of failure.
 *
 * @param attr     DeviceAttirbute that contains the image
 * @param width    Width of the image
