...
//
        ...
        int ret;
        try {
            ret = api_ptr->get_zmq_event_consumer()->subscribe_event(this, attr_name, event, callback, filters,
                                                                     stateless);
        }
        catch (DevFailed &e) {
            ...
            if (reason == API_CommandNotFound) {
                ...
                ret = api_ptr->get_notifd_event_consumer()->subscribe_event(this, attr_name, event, callback, filters,
                                                                            stateless);
            } else
                throw;
        }
...
//
        ...
        try {
            ...
            if (reason == API_CommandNotFound) {
                ...
                ret = api_ptr->get_notifd_event_consumer()->subscribe_event(this, attr_name, event, event_queue_size,
                                                                            filters, stateless);
            } else
                throw;
        }
