                                ...
                                if (vers >= 4) {
                                    ...
                                    if (att_val_4.quality != Tango::ATTR_INVALID) {
                                        if (type == Tango::DEV_ENCODED) {
                                            ...
                                            o
                                                    << " It's not possible to retrieve this data type through the interface you are using (IDL V2)"
                                                    << ends;
                                            Except::throw_exception((const char *) API_NotSupportedFeature,
                                                                    o.str(),
                                                                    (const char *) "Device_2Impl::read_attributes");
...
//--------------------------------------------------------------------------
    ...
    void
    Device_2Impl::Polled_2_Live(TANGO_UNUSED(long data_type), Tango::AttrValUnion &hist_union, CORBA::Any &live_any) {
