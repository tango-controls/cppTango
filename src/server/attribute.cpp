    ...
    try
    {
        ...
        if (event_period_defined)
        {
            ...
            if (str >> event_period_tmp && str.eof())
            {
                ...
                cout1 << "Attribute::Attribute(): event_period_str " << event_period_str << " event_period = "
                      << event_period << endl;
            }
            else
    ...
    try
    {
        ...
        if (archive_period_defined)
        {
            ...
            if (str >> archive_period_tmp && str.eof())
            {
                ...
                cout1 << "Attribute::Attribute(): archive_period_str " << archive_period_str << " archive_period = "
                      << archive_period << endl;
            }
            else
...
void
Attribute::AttributeValue_4_2_AttributeValue_3(const Tango::AttributeValue_4 *ptr_4, Tango::AttributeValue_3 *ptr_3)
{
...
void
Attribute::AttributeValue_5_2_AttributeValue_3(const Tango::AttributeValue_5 *att_5, Tango::AttributeValue_3 *att_3)
{
//
// First copy the data
//
...
void
Attribute::AttributeValue_3_2_AttributeValue_4(const Tango::AttributeValue_3 *att_3, Tango::AttributeValue_4 *att_4)
{
...
void
Attribute::AttributeValue_5_2_AttributeValue_4(const Tango::AttributeValue_5 *att_5, Tango::AttributeValue_4 *att_4)
{
//
...
void
Attribute::AttributeValue_3_2_AttributeValue_5(const Tango::AttributeValue_3 *att_3, Tango::AttributeValue_5 *att_5)
{
// TODO: Code data from Any to Union
...
void
Attribute::AttributeValue_4_2_AttributeValue_5(const Tango::AttributeValue_4 *att_4, Tango::AttributeValue_5 *att_5)
{
//
// First pass the data from one union to another WITHOUT copying them
//
...
void
Attribute::AttributeConfig_5_2_AttributeConfig_3(const Tango::AttributeConfig_5 &conf5, Tango::AttributeConfig_3 &conf3)
{
    size_t j;
...
void
Attribute::AttributeConfig_3_2_AttributeConfig_5(const Tango::AttributeConfig_3 &conf3, Tango::AttributeConfig_5 &conf5)
{
    size_t j;
            ...
            switch (quality)
            {
                case ATTR_INVALID:
                    if (dev->get_logger()->is_error_enabled())
                        dev->get_logger()->error_stream() << log4tango::LogInitiator::_begin_log
                                                          << "INVALID quality for attribute " << name << endl;
                    break;

                case ATTR_CHANGING:
                    if (dev->get_logger()->is_info_enabled())
                        dev->get_logger()->info_stream() << log4tango::LogInitiator::_begin_log
                                                         << "CHANGING quality for attribute " << name << endl;
                    break;

                case ATTR_VALID:
                    if (dev->get_logger()->is_info_enabled())
                        dev->get_logger()->info_stream() << log4tango::LogInitiator::_begin_log
                                                         << "VALID quality for attribute " << name << endl;
                    break;
...
//
            ...
            if (alarm[min_level] == true)
            {
                if (dev->get_logger()->is_error_enabled())
                    dev->get_logger()->error_stream() << log4tango::LogInitiator::_begin_log
                                                      << "MIN ALARM for attribute " << name << endl;
            }
            else if (alarm[max_level] == true)
            {
                if (dev->get_logger()->is_error_enabled())
                    dev->get_logger()->error_stream() << log4tango::LogInitiator::_begin_log
                                                      << "MAX ALARM for attribute " << name << endl;
            }
            else if (alarm[rds] == true)
            {
                if (dev->get_logger()->is_warn_enabled())
                    dev->get_logger()->warn_stream() << log4tango::LogInitiator::_begin_log
                                                     << "RDS (Read Different Set) ALARM for attribute " << name << endl;
            }
            else if (alarm[min_warn] == true)
            {
                if (dev->get_logger()->is_warn_enabled())
                    dev->get_logger()->warn_stream() << log4tango::LogInitiator::_begin_log
                                                     << "MIN WARNING for attribute " << name << endl;
            }
            else if (alarm[max_warn] == true)
            {
                if (dev->get_logger()->is_warn_enabled())
                    dev->get_logger()->warn_stream() << log4tango::LogInitiator::_begin_log
                                                     << "MAX WARNING for attribute " << name << endl;
            }
        }
    }
    else
