#!/usr/bin/env bash
docker exec cpp_tango mkdir -p /home/tango/src/idl/build
docker exec cpp_tango mkdir -p /home/tango/src/build

echo "Build tango-idl"
docker exec cpp_tango cmake -H/home/tango/src/idl -B/home/tango/src/idl/build -DCMAKE_INSTALL_PREFIX=/home/tango
echo "Install tango-idl"
docker exec cpp_tango make -C /home/tango/src/idl/build install
