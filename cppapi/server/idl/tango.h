...
_CORBA_MODULE_BEG
  ...
  public:
    ...
    ClntIdent(const ClntIdent& _value) : _pd__initialised(0) {
      switch(_value._pd__d) {
        case CPP: cpp_clnt(_value.cpp_clnt()); break;

        case JAVA: java_clnt(_value.java_clnt()); break;
    ...
    void java_clnt (const JavaClntIdent& _value) {
      ...
      _pd__d = JAVA;
      _pd__default = 0;
      _pd_java_clnt = new JavaClntIdent(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void java_clnt (JavaClntIdent* _value) {
  ...
  public:
    ...
    AttrValUnion(const AttrValUnion& _value) : _pd__initialised(0) {
      switch(_value._pd__d) {
        case ATT_BOOL: bool_att_value(_value.bool_att_value()); break;

        case ATT_SHORT: short_att_value(_value.short_att_value()); break;

        case ATT_LONG: long_att_value(_value.long_att_value()); break;

        case ATT_LONG64: long64_att_value(_value.long64_att_value()); break;

        case ATT_FLOAT: float_att_value(_value.float_att_value()); break;

        case ATT_DOUBLE: double_att_value(_value.double_att_value()); break;

        case ATT_UCHAR: uchar_att_value(_value.uchar_att_value()); break;

        case ATT_USHORT: ushort_att_value(_value.ushort_att_value()); break;

        case ATT_ULONG: ulong_att_value(_value.ulong_att_value()); break;

        case ATT_ULONG64: ulong64_att_value(_value.ulong64_att_value()); break;

        case ATT_STRING: string_att_value(_value.string_att_value()); break;

        case ATT_STATE: state_att_value(_value.state_att_value()); break;

        case DEVICE_STATE: dev_state_att(_value.dev_state_att()); break;

        case ATT_ENCODED: encoded_att_value(_value.encoded_att_value()); break;

        case ATT_NO_DATA: union_no_data(_value.union_no_data()); break;
    ...
    void bool_att_value (const DevVarBooleanArray& _value) {
      ...
      _pd__d = ATT_BOOL;
      _pd__default = 0;
      _pd_bool_att_value = new DevVarBooleanArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void bool_att_value (DevVarBooleanArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_BOOL;
    ...
    void short_att_value (const DevVarShortArray& _value) {
      ...
      _pd__d = ATT_SHORT;
      _pd__default = 0;
      _pd_short_att_value = new DevVarShortArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void short_att_value (DevVarShortArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_SHORT;
    ...
    void long_att_value (const DevVarLongArray& _value) {
      ...
      _pd__d = ATT_LONG;
      _pd__default = 0;
      _pd_long_att_value = new DevVarLongArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void long_att_value (DevVarLongArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_LONG;
    ...
    void long64_att_value (const DevVarLong64Array& _value) {
      ...
      _pd__d = ATT_LONG64;
      _pd__default = 0;
      _pd_long64_att_value = new DevVarLong64Array(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void long64_att_value (DevVarLong64Array* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_LONG64;
    ...
    void float_att_value (const DevVarFloatArray& _value) {
      ...
      _pd__d = ATT_FLOAT;
      _pd__default = 0;
      _pd_float_att_value = new DevVarFloatArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void float_att_value (DevVarFloatArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_FLOAT;
    ...
    void double_att_value (const DevVarDoubleArray& _value) {
      ...
      _pd__d = ATT_DOUBLE;
      _pd__default = 0;
      _pd_double_att_value = new DevVarDoubleArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void double_att_value (DevVarDoubleArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_DOUBLE;
    ...
    void uchar_att_value (const DevVarCharArray& _value) {
      ...
      _pd__d = ATT_UCHAR;
      _pd__default = 0;
      _pd_uchar_att_value = new DevVarCharArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void uchar_att_value (DevVarCharArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_UCHAR;
    ...
    void ushort_att_value (const DevVarUShortArray& _value) {
      ...
      _pd__d = ATT_USHORT;
      _pd__default = 0;
      _pd_ushort_att_value = new DevVarUShortArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void ushort_att_value (DevVarUShortArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_USHORT;
    ...
    void ulong_att_value (const DevVarULongArray& _value) {
      ...
      _pd__d = ATT_ULONG;
      _pd__default = 0;
      _pd_ulong_att_value = new DevVarULongArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void ulong_att_value (DevVarULongArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_ULONG;
    ...
    void ulong64_att_value (const DevVarULong64Array& _value) {
      ...
      _pd__d = ATT_ULONG64;
      _pd__default = 0;
      _pd_ulong64_att_value = new DevVarULong64Array(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void ulong64_att_value (DevVarULong64Array* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_ULONG64;
    ...
    void string_att_value (const DevVarStringArray& _value) {
      ...
      _pd__d = ATT_STRING;
      _pd__default = 0;
      _pd_string_att_value = new DevVarStringArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void string_att_value (DevVarStringArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_STRING;
    ...
    void state_att_value (const DevVarStateArray& _value) {
      ...
      _pd__d = ATT_STATE;
      _pd__default = 0;
      _pd_state_att_value = new DevVarStateArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void state_att_value (DevVarStateArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_STATE;
    ...
    void encoded_att_value (const DevVarEncodedArray& _value) {
      ...
      _pd__d = ATT_ENCODED;
      _pd__default = 0;
      _pd_encoded_att_value = new DevVarEncodedArray(_value);
    }
#ifdef OMNIORB_EXTENDED_UNION_MAPPING
    void encoded_att_value (DevVarEncodedArray* _value) {
      // Non-standard method, consumes _value
      _release_member();
      _pd__initialised = 1;
      _pd__d = ATT_ENCODED;
