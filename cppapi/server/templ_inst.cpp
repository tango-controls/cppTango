...
template std::ostream &operator<<(std::ostream &,DataElement<DevBoolean> &);
template std::ostream &operator<<(std::ostream &,DataElement<short> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevLong> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevLong64> &);
template std::ostream &operator<<(std::ostream &,DataElement<float> &);
template std::ostream &operator<<(std::ostream &,DataElement<double> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevUChar> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevUShort> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevULong> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevULong64> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevState> &);
...
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevLong64> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<float> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<double> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevUChar> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevUShort> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevULong> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevULong64> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevString> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevState> > &);
//template std::ostream &operator<<(std::ostream &,DataElement<std::vector<DevEncoded> > &);
template std::ostream &operator<<(std::ostream &,DataElement<std::vector<std::string> > &);

template std::ostream &operator<<(std::ostream &,DataElement<DevVarBooleanArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarShortArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarLongArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarLong64Array *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarFloatArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarDoubleArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarUCharArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarUShortArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarULongArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarULong64Array *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarStringArray *> &);
template std::ostream &operator<<(std::ostream &,DataElement<DevVarStateArray *> &);
