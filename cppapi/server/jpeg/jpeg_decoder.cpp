...
char *jpeg_get_error_msg(int code) {
  ...
  switch(-code) {
    case  0: snprintf(retMsg, sizeof(retMsg),"No error");break;
    case  1: snprintf(retMsg, sizeof(retMsg),"Can't find start of image (SOI), may be not a jpeg stream");break;
    case  2: snprintf(retMsg, sizeof(retMsg),"Not supported jpeg format");break;
    case  3: snprintf(retMsg, sizeof(retMsg),"Unexpected jpeg marker found");break;
    case  4: snprintf(retMsg, sizeof(retMsg),"Unexpected end of stream or marker not found");break;
    case  5: snprintf(retMsg, sizeof(retMsg),"Bad DQT marker");break;
    case  6: snprintf(retMsg, sizeof(retMsg),"Invalid quantization table index");break;
    case  7: snprintf(retMsg, sizeof(retMsg),"Invalid quantization table size");break;
    case  8: snprintf(retMsg, sizeof(retMsg),"Invalid variable marker length");break;
    case  9: snprintf(retMsg, sizeof(retMsg),"Bad DHT marker");break;
    case 10: snprintf(retMsg, sizeof(retMsg),"Bad DHT count");break;
    case 11: snprintf(retMsg, sizeof(retMsg),"Bad DHT index");break;
    case 12: snprintf(retMsg, sizeof(retMsg),"Bad SOS marker");break;
    case 13: snprintf(retMsg, sizeof(retMsg),"Bad component id");break;
    case 14: snprintf(retMsg, sizeof(retMsg),"Only 8 bit precision supported");break;
    case 15: snprintf(retMsg, sizeof(retMsg),"Invalid image size (8192x8192 max)");break;
    case 16: snprintf(retMsg, sizeof(retMsg),"Too many components in frame");break;
    case 17: snprintf(retMsg, sizeof(retMsg),"Bad SOF marker");break;
    case 18: snprintf(retMsg, sizeof(retMsg),"Bad DRI marker");break;
    case 19: snprintf(retMsg, sizeof(retMsg),"One or more quantisation table(s) are missing");break;
    case 20: snprintf(retMsg, sizeof(retMsg),"One or more huffman table(s) are missing");break;
    case 21: snprintf(retMsg, sizeof(retMsg),"Downsampling factor not supported");break;
    case 22: snprintf(retMsg, sizeof(retMsg),"Not enough memory");break;
    case 23: snprintf(retMsg, sizeof(retMsg),"Bad restart marker");break;
    case 24: snprintf(retMsg, sizeof(retMsg),"Decoding error");break;
    case 25: snprintf(retMsg, sizeof(retMsg),"Component info missing");break;
    case 26: snprintf(retMsg, sizeof(retMsg),"Progressive format not supported");break;
    case 27: snprintf(retMsg, sizeof(retMsg),"YH2V1 format not supported");break;
    case 28: snprintf(retMsg, sizeof(retMsg),"YH1V2 format not supported");break;
  }
