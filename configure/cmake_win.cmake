...
if (CMAKE_BUILD_TYPE STREQUAL "Debug")
    ...
    #adding tango since there seems to be a bug
...
if(CMAKE_VS_PLATFORM_TOOLSET STREQUAL "v141")
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omniORB421_vc141_rtd.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omniDynamic421_vc141_rtd.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omnithread40_vc141_rtd.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/COS421_vc141_rtd.dll DESTINATION bin COMPONENT dynamic)
    else(CMAKE_BUILD_TYPE STREQUAL "Debug")
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omniORB421_vc141_rt.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omniDynamic421_vc141_rt.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/omnithread40_vc141_rt.dll DESTINATION bin COMPONENT dynamic)
        install(FILES $ENV{OMNI_BASE}/bin/x86_win32/COS421_vc141_rt.dll DESTINATION bin COMPONENT dynamic)
    endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
endif(CMAKE_VS_PLATFORM_TOOLSET STREQUAL "v141")

if(CMAKE_BUILD_TYPE STREQUAL "Debug")
        install(FILES $ENV{ZMQ_BASE}/lib/Debug/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-gd-4_0_5.lib DESTINATION lib COMPONENT static)
        install(FILES $ENV{ZMQ_BASE}/lib/Debug/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-sgd-4_0_5.lib DESTINATION lib COMPONENT static)
        install(FILES $ENV{ZMQ_BASE}/bin/Debug/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-gd-4_0_5.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_BUILD_TYPE STREQUAL "Debug")
        install(FILES $ENV{ZMQ_BASE}/lib/Release/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-4_0_5.lib DESTINATION lib COMPONENT static)
        install(FILES $ENV{ZMQ_BASE}/lib/Release/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-s-4_0_5.lib DESTINATION lib COMPONENT static)
        install(FILES $ENV{ZMQ_BASE}/bin/Release/libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-4_0_5.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
