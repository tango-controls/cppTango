...
install(DIRECTORY log4tango/include/log4tango DESTINATION include COMPONENT headers FILES_MATCHING PATTERN "*.h" PATTERN "*.txt" EXCLUDE PATTERN "*.vcproj" EXCLUDE PATTERN "*.cpp" EXCLUDE PATTERN "*.in" EXCLUDE PATTERN "*.am" EXCLUDE PATTERN "log4tango/include/log4tango/CMakeFiles" EXCLUDE PATTERN "log4tango/include/log4tango/threading/" EXCLUDE)
install(DIRECTORY log4tango/include/log4tango/threading DESTINATION include/log4tango COMPONENT headers FILES_MATCHING PATTERN "*.h" PATTERN "*.txt" EXCLUDE PATTERN "*.vcproj" EXCLUDE PATTERN "*.cpp" EXCLUDE PATTERN "*.in" EXCLUDE PATTERN "*.am" EXCLUDE PATTERN "log4tango/include/log4tango/threading/CMakeFiles/" EXCLUDE)
install(DIRECTORY cppapi/server/ DESTINATION include COMPONENT headers FILES_MATCHING PATTERN "*.h" PATTERN "*.txt" EXCLUDE PATTERN "*.vcproj" EXCLUDE PATTERN "*.cmake" EXCLUDE PATTERN "*.cpp" EXCLUDE PATTERN "*.in" EXCLUDE PATTERN "*.am" EXCLUDE PATTERN "cppapi/server/server_objects.dir/" EXCLUDE PATTERN "cppapi/server/CMakeFiles/" EXCLUDE PATTERN "cppapi/server/idl/" EXCLUDE PATTERN "cppapi/server/jpeg/" EXCLUDE PATTERN "cppapi/server/jpeg_mmx/" EXCLUDE)
install(DIRECTORY cppapi/client/ DESTINATION include COMPONENT headers FILES_MATCHING PATTERN "*.h" PATTERN "*.txt" EXCLUDE PATTERN "*.vcproj" EXCLUDE PATTERN "*.cmake" EXCLUDE PATTERN "*.cpp" EXCLUDE PATTERN "*.in" EXCLUDE PATTERN "*.am" EXCLUDE PATTERN "cppapi/client/client_objects.dir/" EXCLUDE PATTERN "cppapi/client/CMakeFiles/" EXCLUDE PATTERN "cppapi/client/helpers/" EXCLUDE)
install(DIRECTORY cppapi/client/helpers/ DESTINATION include/tango/client COMPONENT headers FILES_MATCHING PATTERN "*.h" PATTERN "*.txt" EXCLUDE PATTERN "*.vcproj" EXCLUDE PATTERN "*.cmake" EXCLUDE PATTERN "*.cpp" EXCLUDE PATTERN "*.in" EXCLUDE PATTERN "*.am" EXCLUDE PATTERN "cppapi/client/helpers/CMakeFiles/" EXCLUDE)
