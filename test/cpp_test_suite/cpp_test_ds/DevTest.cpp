...
DevTest::DevTest(Tango::DeviceClass *cl, string &s)
...
/*	enc_format = new char[40];
    ...
    class EnumLabelsDynCommand: public DynCommand
    {
    public:
        EnumLabelsDynCommand()
            : DynCommand(
            "EnumLabelsDynCommand", Tango::CmdArgType::DEV_ENUM, Tango::CmdArgType::DEV_ENUM, "", "Enum labels")
        {
            set_in_enum_labels({"IN Dyn Label 1", "IN Dyn Label 2", "IN Dyn Label 3"});
            set_out_enum_labels({"OUT Dyn Label 1", "OUT Dyn Label 2", "OUT Dyn Label 3"});
        }
    };
...
void DevTest::write_attr_hardware(vector<long> &att_idx)
{
    switch (wattr_throw)
    {
        ...
        case 1:
            Tango::Except::throw_exception("DevTest_WriteAttrHardware",
                                           "DevFailed from write_attr_hardware",
        ...
        case 3:
            if (att_idx.size() >= 2)
                Tango::Except::throw_named_exception(this,
                                                     att_idx[2],
                                                     "DevTest_WriteAttrHardware",
                                                     "bbb",
                                                     "DevTest::write_attr_hardware");
