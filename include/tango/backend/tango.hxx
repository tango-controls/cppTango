...
namespace Tango {
    ...
    struct DevVarStringArray {
        ...
        DevVarStringArray(size_t _max, size_t _len, char* *_val, bool _rel = 0);
...
//            void operator<<=(cdrStream &);
    ...
    struct DevCmdInfoList : public List<DevCmdInfo> {
        DevCmdInfoList() {}
    ...
    struct DevCmdInfoList_2 : public List<DevCmdInfo>  {
        DevCmdInfoList_2() {}
...
//        using DevErrorList<N> = std::array<DevError, N>;

    struct DevErrorList  : public List<DevError> {
        DevErrorList();
...
//            void operator<<=(cdrStream &);
    ...
    struct NamedDevErrorList : public List<NamedDevError> {
        NamedDevErrorList();
...
//            void operator<<=(cdrStream &);
    ...
    public:
        virtual Any command_inout(const std::string &command, const Any &argin) = 0;
    ...
    public:
        ...
        auto command_inout_2(const char *command, const IN &argin,
                             ::Tango::DevSource source) -> decltype(OUT::value_type);
    ...
    public:
        virtual DevAttrHistory_4 *read_attribute_history_4(const std::string &name, int32_t n) = 0;

        virtual DevCmdHistory_4 *command_inout_history_4(const std::string &command, int32_t n) = 0;

        virtual Tango::Any command_inout_4(const std::string &command, const Tango::Any &argin, ::Tango::DevSource source,
        ...
        virtual void
        write_attributes_4(const ::Tango::AttributeValueList_4 &values,
                           const ::Tango::ClntIdent &cl_ident) = 0;
    ...
    public:
        ...
        virtual void
        set_pipe_config_5(const ::Tango::PipeConfigList &new_conf,
                          const ::Tango::ClntIdent &cl_ident) = 0;

        virtual DevPipeData *read_pipe_5(const char *name, const ::Tango::ClntIdent &cl_ident) = 0;

        virtual void
        write_pipe_5(const ::Tango::DevPipeData &value, const ::Tango::ClntIdent &cl_ident) = 0;
