...
/***            ZmqAttrValUnion               ***/
    ...
    public:
        ...
        template<typename T>
        void set_seq(T &) {
            cerr << "In default ZmqAttrValUnion::set_seq!" << endl;
            assert(false);
        }

        template<typename T>
        T &get_seq() {
            cerr << "In default ZmqAttrValUnion::get_seq!" << endl;
            assert(false);
        }
    };
 ...
 *******************************************************************************/
    ...
    class EventConsumer {
        ...
        typedef void    (*EventCallbackFunction)(string event_name, string event_type,
    ...
    public :
        ...
        int connect_event(DeviceProxy *, const string &, EventType, CallBack *, EventQueue *, const vector<string> &,
                          string &, int event_id = 0);
    ...
    protected :
        ...
        virtual void disconnect_event_channel(TANGO_UNUSED(string &channel_name), TANGO_UNUSED(string &endpoint),
                                              TANGO_UNUSED(string &endpoint_event)) {}

        virtual void
        connect_event_system(string &, string &, string &e, const vector<string> &, EvChanIte &, EventCallBackStruct &,
                             DeviceData &, size_t) = 0;
 ...
 *******************************************************************************/
    ...
    private :
        ...
        void main_reconnect(ZmqEventConsumer *, NotifdEventConsumer *, map<string, EventCallBackStruct>::iterator &,
                            map<string, EventChannelStruct>::iterator &);

        void re_subscribe_after_reconnect(ZmqEventConsumer *, NotifdEventConsumer *,
                                          map<string, EventCallBackStruct>::iterator &,
                                          map<string, EventChannelStruct>::iterator &, string &);
    };
 ...
 *******************************************************************************/
    ...
    public:
        DelayedEventUnsubThread(EventConsumer *ec, int id, TangoMonitor *m)
                : event_id(id), ev_cons(ec), the_mon(m) {}
 ...
 *******************************************************************************/
    ...
    public:
        DelayedEventSubThread(EventConsumer *ec, DeviceProxy *_device,
                              ...
                              int _id) : ev_cons(ec), device(_device),
