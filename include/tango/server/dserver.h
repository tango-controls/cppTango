...
public :
    ...
    vector<DeviceClass *> &get_class_list()
    { return class_list; }
    ...
    vector<string> get_poll_th_conf()
...
private:
     ...
     */
    void
    setup_mcast(const string &event_name,
                string &mcast_data,
                int &rate,
                int &ivl,
                Util *tg,
     ...
     *
     * @param obj_name
     * @param obj_name_lower
     * @param client_lib
     * @param attribute
     */
    void update_archive_event_subscription_time(const string &obj_name,
                                                const string &obj_name_lower,
                                                int client_lib,
                                                Attribute &attribute) const;
    void update_change_event_subscription_time(const string &obj_name,
                                               const string &obj_name_lower,
                                               int client_lib,
                                               Attribute &attribute) const;
    void update_periodic_event_subscription_time(int client_lib, Attribute &attribute) const;
    void update_attribute_subscription_time(const string &obj_name,
                                            const string &event_name,
                                            const string &obj_name_lower,
                                            int client_lib,
                                            Attribute &attribute) const;
    void update_data_ready_subscription_time(const string &obj_name, Attribute &attribute) const;
