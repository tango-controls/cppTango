...
private:
	DeviceAttribute		*ext;		// Class extension
};
...
private:
	DeviceDataHistoryExt	*ext;		// Class extension
};
...
private:
	DeviceAttributeHistoryExt	*ext;	// Class extension		
};
...
private:
	DeviceProxyExt		*ext;		// Class extension
