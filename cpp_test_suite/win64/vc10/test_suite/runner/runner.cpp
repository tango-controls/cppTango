...
CxxTest::DynamicSuiteDescription<BlackboxTestSuite> suiteDescription_BlackboxTestSuite( "../../../../new_tests/cxx_blackbox.cpp", 21, "BlackboxTestSuite", Tests_BlackboxTestSuite, suite_BlackboxTestSuite, 103, 108 );

static class TestDescription_BlackboxTestSuite_test_blackbox_device_feature : public CxxTest::RealTestDescription {
public:
 TestDescription_BlackboxTestSuite_test_blackbox_device_feature() : CxxTest::RealTestDescription( Tests_BlackboxTestSuite, suiteDescription_BlackboxTestSuite, 119, "test_blackbox_device_feature" ) {}
...
public:
 TestDescription_AttrConfTestSuite_test_format_prop_for_misc_data_type() : CxxTest::RealTestDescription( Tests_AttrConfTestSuite, suiteDescription_AttrConfTestSuite, 339, "test_format_prop_for_misc_data_type" ) {}
...
static WriteAttrHardware *suite_WriteAttrHardware = 0;

static CxxTest::List Tests_WriteAttrHardware = { 0, 0 };
CxxTest::DynamicSuiteDescription<WriteAttrHardware> suiteDescription_WriteAttrHardware( "../../../../new_tests/cxx_write_attr_hard.cpp", 17, "WriteAttrHardware", Tests_WriteAttrHardware, suite_WriteAttrHardware, 90, 95 );

static class TestDescription_WriteAttrHardware_test_DevFailed_from_write_attr_hardware : public CxxTest::RealTestDescription {
public:
 TestDescription_WriteAttrHardware_test_DevFailed_from_write_attr_hardware() : CxxTest::RealTestDescription( Tests_WriteAttrHardware, suiteDescription_WriteAttrHardware, 106, "test_DevFailed_from_write_attr_hardware" ) {}
 void runTest() { if ( suite_WriteAttrHardware ) suite_WriteAttrHardware->test_DevFailed_from_write_attr_hardware(); }
} testDescription_WriteAttrHardware_test_DevFailed_from_write_attr_hardware;

static class TestDescription_WriteAttrHardware_test_MultiDevFailed_from_name_thrown_by_write_attr_hardware : public CxxTest::RealTestDescription {
public:
 TestDescription_WriteAttrHardware_test_MultiDevFailed_from_name_thrown_by_write_attr_hardware() : CxxTest::RealTestDescription( Tests_WriteAttrHardware, suiteDescription_WriteAttrHardware, 176, "test_MultiDevFailed_from_name_thrown_by_write_attr_hardware" ) {}
 void runTest() { if ( suite_WriteAttrHardware ) suite_WriteAttrHardware->test_MultiDevFailed_from_name_thrown_by_write_attr_hardware(); }
} testDescription_WriteAttrHardware_test_MultiDevFailed_from_name_thrown_by_write_attr_hardware;
...
public:
 TestDescription_WriteAttrHardware_test_MultiDevFailed_from_ind_thrown_by_write_attr_hardware() : CxxTest::RealTestDescription( Tests_WriteAttrHardware, suiteDescription_WriteAttrHardware, 231, "test_MultiDevFailed_from_ind_thrown_by_write_attr_hardware" ) {}
 void runTest() { if ( suite_WriteAttrHardware ) suite_WriteAttrHardware->test_MultiDevFailed_from_ind_thrown_by_write_attr_hardware(); }
} testDescription_WriteAttrHardware_test_MultiDevFailed_from_ind_thrown_by_write_attr_hardware;

#include "../../../../new_tests/cxx_enum_att.cpp"

static EnumAttTestSuite *suite_EnumAttTestSuite = 0;

static CxxTest::List Tests_EnumAttTestSuite = { 0, 0 };
CxxTest::DynamicSuiteDescription<EnumAttTestSuite> suiteDescription_EnumAttTestSuite( "../../../../new_tests/cxx_enum_att.cpp", 18, "EnumAttTestSuite", Tests_EnumAttTestSuite, suite_EnumAttTestSuite, 106, 111 );

static class TestDescription_EnumAttTestSuite_test_enum_attribute_configuration : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_configuration() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 122, "test_enum_attribute_configuration" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_configuration(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_configuration;

static class TestDescription_EnumAttTestSuite_test_enum_attribute_reading : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_reading() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 221, "test_enum_attribute_reading" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_reading(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_reading;

static class TestDescription_EnumAttTestSuite_test_enum_attribute_writing : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_writing() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 249, "test_enum_attribute_writing" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_writing(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_writing;

static class TestDescription_EnumAttTestSuite_test_enum_attribute_write_read : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_write_read() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 292, "test_enum_attribute_write_read" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_write_read(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_write_read;

static class TestDescription_EnumAttTestSuite_test_enum_attribute_memorized : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_memorized() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 310, "test_enum_attribute_memorized" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_memorized(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_memorized;

static class TestDescription_EnumAttTestSuite_test_enum_attribute_polling : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_enum_attribute_polling() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 339, "test_enum_attribute_polling" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_enum_attribute_polling(); }
} testDescription_EnumAttTestSuite_test_enum_attribute_polling;

static class TestDescription_EnumAttTestSuite_test_dynamic_attribute_of_enum_type : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_dynamic_attribute_of_enum_type() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 407, "test_dynamic_attribute_of_enum_type" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_dynamic_attribute_of_enum_type(); }
} testDescription_EnumAttTestSuite_test_dynamic_attribute_of_enum_type;

static class TestDescription_EnumAttTestSuite_test_Dyn_enum : public CxxTest::RealTestDescription {
public:
 TestDescription_EnumAttTestSuite_test_Dyn_enum() : CxxTest::RealTestDescription( Tests_EnumAttTestSuite, suiteDescription_EnumAttTestSuite, 425, "test_Dyn_enum" ) {}
 void runTest() { if ( suite_EnumAttTestSuite ) suite_EnumAttTestSuite->test_Dyn_enum(); }
} testDescription_EnumAttTestSuite_test_Dyn_enum;

#include "../../../../new_tests/cxx_fwd_att.cpp"

static FwdAttTestSuite *suite_FwdAttTestSuite = 0;

static CxxTest::List Tests_FwdAttTestSuite = { 0, 0 };
CxxTest::DynamicSuiteDescription<FwdAttTestSuite> suiteDescription_FwdAttTestSuite( "../../../../new_tests/cxx_fwd_att.cpp", 18, "FwdAttTestSuite", Tests_FwdAttTestSuite, suite_FwdAttTestSuite, 159, 164 );

static class TestDescription_FwdAttTestSuite_test_error_case_in_forwarded_attribute_configuration : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_error_case_in_forwarded_attribute_configuration() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 175, "test_error_case_in_forwarded_attribute_configuration" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_error_case_in_forwarded_attribute_configuration(); }
} testDescription_FwdAttTestSuite_test_error_case_in_forwarded_attribute_configuration;

static class TestDescription_FwdAttTestSuite_test_reading_forwarded_attribute : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_reading_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 256, "test_reading_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_reading_forwarded_attribute(); }
} testDescription_FwdAttTestSuite_test_reading_forwarded_attribute;

static class TestDescription_FwdAttTestSuite_test_writing_forwarded_attribute : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_writing_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 306, "test_writing_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_writing_forwarded_attribute(); }
} testDescription_FwdAttTestSuite_test_writing_forwarded_attribute;

static class TestDescription_FwdAttTestSuite_test_data_propagation : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_data_propagation() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 375, "test_data_propagation" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_data_propagation(); }
} testDescription_FwdAttTestSuite_test_data_propagation;

static class TestDescription_FwdAttTestSuite_test_attribute_configuration : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_attribute_configuration() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 421, "test_attribute_configuration" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_attribute_configuration(); }
} testDescription_FwdAttTestSuite_test_attribute_configuration;

static class TestDescription_FwdAttTestSuite_test_attribute_configuration_propagation : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_attribute_configuration_propagation() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 522, "test_attribute_configuration_propagation" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_attribute_configuration_propagation(); }
} testDescription_FwdAttTestSuite_test_attribute_configuration_propagation;

static class TestDescription_FwdAttTestSuite_test_label_is_local : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_label_is_local() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 552, "test_label_is_local" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_label_is_local(); }
} testDescription_FwdAttTestSuite_test_label_is_local;

static class TestDescription_FwdAttTestSuite_test_write_read_on_forwarded_attribute : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_write_read_on_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 581, "test_write_read_on_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_write_read_on_forwarded_attribute(); }
} testDescription_FwdAttTestSuite_test_write_read_on_forwarded_attribute;

static class TestDescription_FwdAttTestSuite_test_polling_on_a_forwarded_attribute : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_polling_on_a_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 600, "test_polling_on_a_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_polling_on_a_forwarded_attribute(); }
...
public:
 TestDescription_FwdAttTestSuite_test_event_on_a_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 690, "test_event_on_a_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_event_on_a_forwarded_attribute(); }
} testDescription_FwdAttTestSuite_test_event_on_a_forwarded_attribute;

static class TestDescription_FwdAttTestSuite_test_locking_device_with_forwarded_attribute : public CxxTest::RealTestDescription {
public:
 TestDescription_FwdAttTestSuite_test_locking_device_with_forwarded_attribute() : CxxTest::RealTestDescription( Tests_FwdAttTestSuite, suiteDescription_FwdAttTestSuite, 746, "test_locking_device_with_forwarded_attribute" ) {}
 void runTest() { if ( suite_FwdAttTestSuite ) suite_FwdAttTestSuite->test_locking_device_with_forwarded_attribute(); }
} testDescription_FwdAttTestSuite_test_locking_device_with_forwarded_attribute;

#include "../../../../new_tests/cxx_z00_dyn_cmd.cpp"

static DynCmdTestSuite *suite_DynCmdTestSuite = 0;

static CxxTest::List Tests_DynCmdTestSuite = { 0, 0 };
CxxTest::DynamicSuiteDescription<DynCmdTestSuite> suiteDescription_DynCmdTestSuite( "../../../../new_tests/cxx_z00_dyn_cmd.cpp", 17, "DynCmdTestSuite", Tests_DynCmdTestSuite, suite_DynCmdTestSuite, 67, 72 );

static class TestDescription_DynCmdTestSuite_test_dynamic_command_at_class_level : public CxxTest::RealTestDescription {
public:
 TestDescription_DynCmdTestSuite_test_dynamic_command_at_class_level() : CxxTest::RealTestDescription( Tests_DynCmdTestSuite, suiteDescription_DynCmdTestSuite, 83, "test_dynamic_command_at_class_level" ) {}
 void runTest() { if ( suite_DynCmdTestSuite ) suite_DynCmdTestSuite->test_dynamic_command_at_class_level(); }
} testDescription_DynCmdTestSuite_test_dynamic_command_at_class_level;

static class TestDescription_DynCmdTestSuite_test_dynamic_command_at_device_level : public CxxTest::RealTestDescription {
public:
 TestDescription_DynCmdTestSuite_test_dynamic_command_at_device_level() : CxxTest::RealTestDescription( Tests_DynCmdTestSuite, suiteDescription_DynCmdTestSuite, 140, "test_dynamic_command_at_device_level" ) {}
 void runTest() { if ( suite_DynCmdTestSuite ) suite_DynCmdTestSuite->test_dynamic_command_at_device_level(); }
} testDescription_DynCmdTestSuite_test_dynamic_command_at_device_level;
